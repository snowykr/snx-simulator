...
class AbstractState:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self.stack_slots == other.stack_slots
            and self.sp_offset == other.sp_offset
        )
...
class DataflowAnalyzer:
    ...
    def analyze(self) -> DataflowResult:
        ...
        for dw in self._ir_program.initial_data_image:
            entry_state.stack_slots[1000 + dw.address] = ValueState.DATA
        ...
        if opcode == Opcode.LDA:
            ...
            if isinstance(target_op, LabelRefOperand):
                ...
                if isinstance(base_reg, RegisterOperand):
                    reg_state = in_state.registers.get(
                        base_reg.index, ValueState.UNINIT
                    )
    ...
    def _get_stack_slot_key(
        self, addr_op: AddressOperand, state: AbstractState
    ) -> int | None:
